...
I have found an old Stackoverflow thread that explains how to [disable most of the animations](https://apple.stackexchange.com/questions/14001/how-to-turn-off-all-animations-on-os-x) on macOS:
...
### iTerm, Terminal and Shell interface

iTerm and `tmux` are great integrations for a better shell experience. Combined with `zsh`, `oh-my-zsh` and `powerlevel10k`, you can have a highly customized shell interface that suits your needs. I have this setup on my Mac and it's been working great for me, providing a seamless shell experience after logouts and restarts (ie. _persistent shell sessions_) and across multiple machines/ssh sessions to servers.

Some lesser known features of `tmux` + iTerm integrations are described in the [iTerm documentation](https://iterm2.com/documentation.html) and [this HN article](https://news.ycombinator.com/item?id=22461605).
