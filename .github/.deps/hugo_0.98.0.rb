class Hugo < Formula
  desc "Configurable static site generator [v0.98.0]"
  homepage "https://gohugo.io/"
  url "https://github.com/gohugoio/hugo/archive/refs/tags/v0.98.0.tar.gz"
  sha256 "5d993c81d98f88d89f38fbc7139d7d26474c32f344bc220abefad99a66ffff9f"
  head "ssh://github.com/gohugoio/hugo.git", branch: "v0.98.0"
